...
func StartServer() {
	...
	log.Println("[API]   GET /api/sched/metrics           - CPU scheduling metrics")
	log.Println("[API]   GET /api/sched/pods              - Per-pod scheduling metrics")
	log.Println("[API]   GET /api/sched/containers        - Per-container scheduling metrics")
	log.Println("[API]   GET /api/sched/records           - Scheduling latency records")
	log.Println("[API]   GET /api/disk/metrics           - Disk I/O metrics")
	log.Println("[API]   GET /api/disk/pods              - Per-pod disk I/O metrics")
	log.Println("[API]   GET /api/disk/containers        - Per-container disk I/O metrics")
	log.Println("[API]   GET /api/disk/all               - All disk I/O metrics")
	log.Println("[API]   POST /api/pod/action             - Perform pod actions")
	log.Println("[API]   POST /api/pod/ebpf-action        - eBPF-based pod actions")
	log.Println("[API]   GET /api/pod/logs                - Pod logs")
